#!/usr/bin/env python3
"""
Script to add test expenses to the database for demonstration
"""
import sys
...
def add_test_data():
    with app.app_context():
        ...
        # Add expenses with dates spread over last 30 days
        added_count = 0
        for i, exp_data in enumerate(sample_expenses):
            # Create expense with date from past 30 days
